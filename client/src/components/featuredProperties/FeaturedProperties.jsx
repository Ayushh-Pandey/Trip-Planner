            ...
            data.map((item, i) => (
              <div className="fpItem" key={item._id}>
                <img
                  ...
                  className="fpImg"
                />
                <span className="fpName">{item ? item.name : "Hayat Residency"}</span>
                <span className="fpCity">{item ? item.city : "Delhi"}</span>
                <span className="fpPrice">{`Starting from ${item ? item.cheapestPrice : 0}`}</span>
